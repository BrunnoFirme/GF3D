...
void gf3d_vgraphics_rotate_camera(float degrees)
{
    ...
    */
    ...
    //gfc_matrix_set_view_direction(gf3d_vgraphics.ubo.view, vector3d(2, 40, 2), vector3d(.5, 0, 1), vector3d(0, 0, 1));    

}

void gf3d_vgraphics_move_camera(float _x, float _y, float _z)
{
    x += _x;
    y += _y;
    z += _z;
    ...
    */
    ...
    gfc_matrix_translate(gf3d_vgraphics.ubo.view, vector3d(_x,_y,_z));
}
