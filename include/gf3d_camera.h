...
/**
 * @brief move the camera position by a vector 3
 * @param the distance the camera will move
 */
void gf3d_camera_move_position(Vector3D offset);

/**
 * @brief move the camera rotation by a vector 3
 * @param the distance the camera will rotate
 */
